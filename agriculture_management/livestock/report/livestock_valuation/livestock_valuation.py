...
def get_columns():
    ...
    return [
        {"label": _("Livestock ID"), "fieldname": "livestock_id",
         "fieldtype": "Link", "options": "Animal", "width": 160},
        {"label": _("Animal Name"), "fieldname": "animal_name",
         "fieldtype": "Data", "width": 140},
        {"label": _("Age"), "fieldname": "age",
         "fieldtype": "Float", "width": 80},
        {"label": _("Acquisition Cost"), "fieldname": "acquisition_cost",
         "fieldtype": "Currency", "width": 140},
        {"label": _("Calculated Value"), "fieldname": "calculated_value",
         "fieldtype": "Currency", "width": 140},
...
def get_data(filters):
    ...
    for animal in animals_to_process:
        acquisition_cost = frappe.db.get_value(
            "Asset", animal.asset, "value_after_depreciation") if animal.asset else 0
        ...
        if valuation_method == "Acquisition Cost":
            ...
            calculated_value = get_value_by_last_purchase_price(
                animal.item_code, as_on_date)
